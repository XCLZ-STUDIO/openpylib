...
_PyWideStringList_Clear(PyWideStringList
*list);

PyAPI_FUNC(int)

_PyWideStringList_Copy(PyWideStringList
*list,
const PyWideStringList *list2
);
PyAPI_FUNC(PyStatus)
_PyWideStringList_Extend(PyWideStringList
*list,
const PyWideStringList *list2
);
PyAPI_FUNC(PyObject
...
_PyArgv_AsWstrList(const _PyArgv *args,
...
_PyPreConfig_InitCompatConfig(PyPreConfig
*preconfig);
...
_PyConfig_InitCompatConfig(PyConfig
*config);
