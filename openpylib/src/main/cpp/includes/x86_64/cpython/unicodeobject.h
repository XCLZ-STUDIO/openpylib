...
typedef struct {
    ...
    */
    PyObject_HEAD
            Py_ssize_t
    length;          /* Number of code points in the string */
...
PyUnicode_New(
        Py_ssize_t
size,            /* Number of code points in the new string */
...
_PyUnicodeWriter_Init(_PyUnicodeWriter
*writer);
...
_PyUnicodeWriter_PrepareInternal(_PyUnicodeWriter
*writer,
Py_ssize_t length, Py_UCS4
maxchar);
...
_PyUnicodeWriter_PrepareKindInternal(_PyUnicodeWriter
*writer,
enum PyUnicode_Kind kind
);
...
_PyUnicodeWriter_WriteChar(_PyUnicodeWriter
*writer,
Py_UCS4 ch
);
...
_PyUnicodeWriter_WriteSubstring(_PyUnicodeWriter
*writer,
PyObject *str,              /* Unicode string */
        Py_ssize_t
start,
...
const char *str,           /* ASCII-encoded byte string */
        Py_ssize_t
len             /* number of bytes, or -1 if unknown */
);
...
PyAPI_FUNC(PyObject
*)
_PyUnicodeWriter_Finish(_PyUnicodeWriter
*writer);

/* Deallocate memory of a writer (clear its internal buffer). */
PyAPI_FUNC(void)

_PyUnicodeWriter_Dealloc(_PyUnicodeWriter
*writer);
...
/* Py_DEPRECATED(3.3) */ PyAPI_FUNC(Py_UCS4)
...
PyAPI_FUNC(PyObject
*)
_PyUnicode_FormatLong(PyObject
*, int, int, int);
...
PyAPI_FUNC(PyObject
*)
_PyUnicode_FromId(_Py_Identifier
*);
