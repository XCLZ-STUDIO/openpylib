...
Py_SetStandardStreamEncoding(const char *encoding,
                             const char *errors);
...
_Py_NO_RETURN Py_ExitStatusException(PyStatus
err);
...
_Py_PyAtExit(void (*func)(PyObject *), PyObject *);
...
_Py_SetProgramFullPath(const wchar_t *);
