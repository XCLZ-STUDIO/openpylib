...
PyParser_SimpleParseStringFlags(const char *, int,
                                int);
...
PyParser_SimpleParseStringFlagsFilename(const char *,
                                        const char *,
                                        int, int);
...
PyParser_SimpleParseFileFlags(FILE
*, const char *,
int, int);
...
PyRun_StringFlags(const char *, int, PyObject *,
...
*(*PyOS_ReadlineFunctionPointer)(FILE *, FILE *, const char *);
#ifndef Py_LIMITED_API
PyAPI_DATA(PyThreadState
*)
