...
_Py_VaBuildValue_SizeT(const char *, va_list);
...
_PyArg_BadArgument(const char *, const char *, const char *, PyObject *);

PyAPI_FUNC(int)

_PyArg_CheckPositional(const char *, Py_ssize_t,
...
Py_VaBuildValue(const char *, va_list);
...
_PyArg_ParseTupleAndKeywordsFast(PyObject
*, PyObject *,
...
_PyArg_VaParseTupleAndKeywordsFast(PyObject
*, PyObject *,
...
_PyModule_CreateInitialized(struct PyModuleDef *,
                            int apiver);
