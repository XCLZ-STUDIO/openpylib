...
_PyPathConfig_Clear(_PyPathConfig
*config);
...
_PyInterpreterState_IDIncref(PyInterpreterState
*);

PyAPI_FUNC(void)

_PyInterpreterState_IDDecref(PyInterpreterState
*);
