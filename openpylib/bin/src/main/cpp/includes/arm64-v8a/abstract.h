...
_PyObject_HasFastCall(PyObject
*callable);
...
PyAPI_FUNC(PyObject
*)
_PyObject_CallFunction_SizeT(PyObject
*callable,
const char *format,
...
);
...
PyAPI_FUNC(PyObject
*)
_PyObject_CallMethod_SizeT(PyObject
*obj,
const char *name,
const char *format,
...
...
PyObject_DelItemString(PyObject
*o,
const char *key
);
